...
class UiBoardMapperTest {
    ...
    fun `map game board from a full board to ui board`() {
        ...
        assertThat(uiBoard.boardListItem[0]).isEqualTo(BoardItem(1, Player.O))
        assertThat(uiBoard.boardListItem[4]).isEqualTo(BoardItem(5, Player.X))
        assertThat(uiBoard.boardListItem[8]).isEqualTo(BoardItem(9, Player.X))
